...
# ----------------------------------------------------------------------------
# File Name         :       tests/test_example_2.py
...
#
# Usage             :       pytest ./numpy/tests/test_example_2.py
#
# Output            :       ./numpy/tests/results/test_results_example_2.txt
#
# ---------------------------------------------------------------------------
#
...
"""
Unit tests for example_2.py script.
"""
...
def log_results(output, script_name):
    """
    Log the test results to a file.

    Parameters:
    - output (str): Output captured from the script.
    - script_name (str): Name of the script being tested.
    """
    results_folder = "./results/"
    os.makedirs(results_folder, exist_ok=True)

    # Extract the filename without the extension
    script_filename = os.path.splitext(os.path.basename(script_name))[0]

    result_file_path = os.path.join(results_folder, f"test_results_{script_filename}.txt")
